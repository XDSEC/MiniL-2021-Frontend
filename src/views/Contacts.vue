<template>
  <div class="container">
    ...
    <div class="mine-container">
      ...
      <!-- 加载图标 -->
      <div v-show="tableLoading" class="loading">
        <font-awesome-icon icon="spinner" spin/>
      </div>
      <div v-show="!tableLoading" class="mine-bottom-container">
        <el-table :data="solve_detail" border height="280" max-height="280px" stripe style="width: 720px">
          <el-table-column label="时间" prop="date" width="180"></el-table-column>
          <el-table-column label="分类" prop="challenge.category" width="180"></el-table-column>
          <el-table-column label="题目" prop="challenge.name" width="180"></el-table-column>
          <el-table-column label="分值" prop="challenge.value"></el-table-column>
        </el-table>
      </div>
    </div>
  </div>
