    ...
    <div class="container">
        <div class="login-container">
            ...
            <div class="bottom" v-show="showLogin">
                <input type="text" placeholder="队伍名称" v-model="loginName" />
            ...
            <div class="register-container" v-show="!showLogin">
                <input type="text" placeholder="队伍名称" v-model="registerName" />
                <input type="text" placeholder="联系邮箱" v-model="registerEmail" />
